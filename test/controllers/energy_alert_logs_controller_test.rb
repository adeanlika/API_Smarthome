...
class EnergyAlertLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create energy_alert_log" do
    assert_difference('EnergyAlertLog.count') do
      post energy_alert_logs_url, params: { energy_alert_log: { : @energy_alert_log., : @energy_alert_log., : @energy_alert_log., home_name: @energy_alert_log.home_name, status: @energy_alert_log.status, value: @energy_alert_log.value } }, as: :json
    end
  ...
  test "should update energy_alert_log" do
    patch energy_alert_log_url(@energy_alert_log), params: { energy_alert_log: { : @energy_alert_log., : @energy_alert_log., : @energy_alert_log., home_name: @energy_alert_log.home_name, status: @energy_alert_log.status, value: @energy_alert_log.value } }, as: :json
    assert_response 200
  end
